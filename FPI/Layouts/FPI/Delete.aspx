...
<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="Delete.aspx.vb" Inherits="FPI.Layouts.FPI.Delete" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <table>
        ...
        <tr>
            <td>
                <br />
                <asp:Button ID="DeleteBtn" runat="server" Enabled="false" Text="Delete" OnClick="SubmitDelete" />
            </td>
        </tr>
    </table>
    ...
    <asp:SqlDataSource ID="FPISql" runat="server" 
        ...
        UpdateCommand="FPI_Delete" UpdateCommandType="StoredProcedure">
        <SelectParameters>
